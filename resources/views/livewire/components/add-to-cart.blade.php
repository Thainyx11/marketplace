    ...
    @if ($product->stock > 0 && (! auth()->check() || auth()->user()->isAcheteur()))
        <div class="flex items-center gap-3">
            ...
            <button wire:click="add" type="button"
                    class="flex-1 bg-brand-800 hover:bg-brand-700 text-white font-semibold px-6 py-2.5 rounded-full shadow-sm shadow-brand-800/20 hover:shadow-md transition-all">
