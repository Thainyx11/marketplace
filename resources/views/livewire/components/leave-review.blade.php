<div class="mt-3 bg-gray-50 dark:bg-gray-900 rounded-xl p-4">
    ...
    @else
        <form wire:submit="submit" class="space-y-2">
            ...
            <select wire:model="rating" class="block rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 text-sm focus:border-brand-500 focus:ring-brand-500">
            ...
            <textarea wire:model="comment" rows="2" placeholder="{{ __('Votre commentaire (optionnel)') }}"
                      class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 text-sm focus:border-brand-500 focus:ring-brand-500"></textarea>
