        ...
        <aside class="lg:col-span-1 space-y-5 bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-sm h-fit lg:sticky lg:top-20">
            <div>
                ...
                <input type="text" wire:model.live.debounce.400ms="search" placeholder="{{ __('Titre ou description...') }}"
                       class="mt-1.5 w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 text-sm focus:border-violet-500 focus:ring-violet-500">
            </div>

            <div>
                <label class="text-xs font-bold uppercase tracking-wide text-gray-500 dark:text-gray-400">{{ __('Catégorie') }}</label>
                <select wire:model.live="category" class="mt-1.5 w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 text-sm focus:border-violet-500 focus:ring-violet-500">
            ...
            <div>
                ...
                <select wire:model.live="brand" class="mt-1.5 w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 text-sm focus:border-violet-500 focus:ring-violet-500">
            ...
            <div>
                ...
                <select wire:model.live="condition" class="mt-1.5 w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 text-sm focus:border-violet-500 focus:ring-violet-500">
            ...
            @if ($rarities->isNotEmpty())
                <div>
                    ...
                    <select wire:model.live="rarity" class="mt-1.5 w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 text-sm focus:border-violet-500 focus:ring-violet-500">
                        <option value="">{{ __('Toutes') }}</option>
            ...
            <div>
                ...
                <div class="flex items-center gap-2 mt-1.5">
                    <input type="number" min="0" step="0.01" wire:model.live.debounce.400ms="minPrice" placeholder="{{ __('Min') }}"
                           class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 text-sm focus:border-violet-500 focus:ring-violet-500">
            ...
            <button type="button" wire:click="resetFilters" class="text-sm font-semibold text-violet-600 dark:text-violet-400 hover:underline">
        ...
        <div class="lg:col-span-3">
            <div class="flex items-center justify-between mb-4">
                <p class="text-sm text-gray-500 dark:text-gray-400 flex items-center gap-2">
                    ...
                    <svg wire:loading wire:target="search,category,brand,condition,rarity,minPrice,maxPrice,sort" class="animate-spin h-3.5 w-3.5 text-violet-500" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path>
                    </svg>
                </p>

                <select wire:model.live="sort" class="rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 text-sm focus:border-violet-500 focus:ring-violet-500">
